            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Ubah Data Kriteria</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form pt-3" method="post" action="update_kriteria.php" enctype="multipart/form-data">
                                    ...
                                    <?php foreach ($db->select('*', 'kriteria')->where('id_kriteria=' . $_GET['id'])->get() as $data) : ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kriteria" name="kriteria" value="<?= $data['kriteria'] ?>" aria-label="Nama Lengkap" aria-describedby="basic-addon11">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon22"><i class="ti-receipt"></i></span>
                                                </div>

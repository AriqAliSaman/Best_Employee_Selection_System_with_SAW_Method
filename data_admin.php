...
<body class="skin-default fixed-layout">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div><a href="input_admin.php" id="tambah_admin" class="btn btn-info tambah_admin"><i class="ti-plus"></i> Tambah Data</a></div>
                                            ...
                                            foreach ($db->select('*', 'admin')->get() as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 138px;">
                                                        ...
                                                        ?>
                                                        <a class="btn btn-warning" href="edit_admin.php?id=<?php echo $data[0] ?>">Ubah</a>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.3/css/intlTelInput.min.css"></script>

            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Data Sub Kriteria</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div><a href="input_subkriteria.php" id="sk" class="btn btn-info"><i class="ti-plus"></i> Tambah Data</a></div>
                                            ...
                                            foreach ($db->select('sub_kriteria.id_subkriteria,sub_kriteria.subkriteria,kriteria.kriteria,sub_kriteria.nilai', 'sub_kriteria,kriteria')->where('sub_kriteria.id_kriteria=kriteria.id_kriteria')->get() as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="width: 150px;">
                                                        <a class="btn btn-warning" href="edit_subkriteria.php?id=<?php echo $data[0] ?>">Ubah</a>
                                                        <button class="btn btn-danger img-fluid model_img text-white hapus" data-id="<?php echo $data[0] ?>">Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php $no++;
                                            endforeach; ?>

                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Terlalu pendek: Minimum of '" + $this.attr("minlength") + "' characters<!-- data-validation-minlength-message to override -->";
        ...
        , validatorTypes: {
            ...
            , minlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Terlalu pendek: Minimum of '" + result.minlength + "' characters";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
